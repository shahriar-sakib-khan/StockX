    ...
    persist(
        (set, get) => ({
            ...
            hasUncommittedChanges: () => {
                ...
                return (
                    JSON.stringify(regulator) !==
                        JSON.stringify(draftRegulator) ||
            ...
            updateRegulatorStock: (stockChange) => {
                ...
                set({
                    draftRegulator: {
                        ...draftRegulator,
                        stock: clampValue(draftRegulator.stock + stockChange),
                    },
                });
            },
            ...
            setStovePrice: (newPrice) => {
                const { draftStove } = get();
                set({
                    draftStove: { ...draftStove, price: clampValue(newPrice) },
                });
            },
            ...
            setStoveStock: (newStock) => {
                const { draftStove } = get();
                set({
                    draftStove: { ...draftStove, stock: clampValue(newStock) },
                });
            },
            ...
            updateStoveStock: (stockChange) => {
                ...
                set({
                    draftStove: {
                        ...draftStove,
                        stock: clampValue(draftStove.stock + stockChange),
                    },
                });
            },
        }),
