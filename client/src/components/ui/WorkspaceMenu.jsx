  ...
  return (
    <div className={clsx("relative", className)} ref={menuRef}>
      <button
        ...
        className={clsx(
          "ml-4 flex cursor-pointer items-center space-x-2 rounded-full bg-transparent transition-opacity duration-100 hover:opacity-80",
      ...
      {open && (
        <div
          className={clsx(
            "z-100 min-w-40 rounded-md bg-white p-2 text-nowrap shadow-lg ring-1 ring-gray-300",
            sidebar
              ? "absolute right-2 bottom-6 left-3 mb-2"
        ...
        >
          <section className="mb-2 flex gap-2 border-b-1 border-gray-300 pb-2">
            ...
            <div className="flex flex-col gap-0">
              ...
              <span className="text-sm text-gray-500">{email || "Friend"}</span>
            </div>
          </section>
