...
export interface IMembership extends Document {
  ...
  status: constants.WorkspaceMembershipStatusType;
...
const membershipSchema: Schema<IMembership> = new Schema(
  {
    ...
    workspaceRoles: { type: [String], default: [] },
    status: { type: String, enum: constants.WorkspaceMembershipStatuses, default: 'active' },
